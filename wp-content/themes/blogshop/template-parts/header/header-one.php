...
$header_pt = (true === $gettopbar ? ' pt-0' : '');
?>	
<header id="masthead" class="site-header header-one<?php echo esc_attr($header_pt);?>" style="background-image: url(<?php echo esc_url( get_header_image());?>);">
		<?php
		if (true == $gettopbar) :
		 ?>
